 ...
 */
var SPACE_FACTS = "EMS is on the way."
...
SpaceGeek.prototype.intentHandlers = {
    "GetNewFactIntent": function (intent, session, response) {
        var speechOutput = "ems on the way"
        response.tell(speechOutput);
    },
        "contactFamily" : function (intent, session, response){
        var speechOutput = "your family has been notified"
        response.tell(speechOutput);
    },
