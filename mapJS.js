...
require([
  ...
  function(
    ...
    var infoTemplate = new InfoTemplate("${NAME}", "Name: ${name} <br> Health: ${health} <br> Address:  ${address} <br> Long: ${long} <br> Lat: ${lat} ");
    ...
    var featureLayer = new FeatureLayer
      ...
      ("http://services.arcgis.com/8rbxAaK6cXWFIkYX/arcgis/rest/services/Book3/FeatureServer/0", {
